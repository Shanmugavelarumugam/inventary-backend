...
export class SettingsController {
  ...
  async getBusiness(@CurrentUser('businessId') businessId: string) {
    return await this.settingsService.getBusinessProfile(businessId);
  }
  ...
  async updateBusiness(
    ...
    return await this.settingsService.updateBusinessProfile(businessId, data);
  }

  @Get('tax')
  async getTax(@CurrentUser('businessId') businessId: string) {
    return await this.settingsService.getTaxSettings(businessId);
  }
  ...
  async updateTax(
    @CurrentUser('businessId') businessId: string,
    @Body() data: { taxId?: string },
  ) {
    return await this.settingsService.updateTaxSettings(businessId, data);
  }

  @Get('invoice-template')
  getInvoiceTemplate(@CurrentUser('businessId') businessId: string) {
  ...
  @Get('notifications')
  getNotifications(@CurrentUser('businessId') businessId: string) {
  ...
  @Get('integrations')
  getIntegrations(@CurrentUser('businessId') businessId: string) {
